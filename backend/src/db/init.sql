...
-- Per-user patient favorites for clinician bookmarks
...
-- Organization access requests that patients can approve or reject
...
-- Patient lab results (structured, extracted from uploaded documents)
...
-- Patient vaccinations (extracted from uploaded documents)
