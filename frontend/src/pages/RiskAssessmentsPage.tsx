        ...
        <Box>
            ...
            <Grid container spacing={2.5}>
                <Grid size={{ xs: 12, md: 4 }}>
                    <Card sx={{ height: "100%", background: "linear-gradient(160deg, #0f172a 0%, #1e3a5f 60%, #2563eb 100%)", color: "white", border: "none" }}>
                            ...
                            <Box sx={{ height: 300, width: "100%" }}>
                                <ResponsiveContainer width="100%" height="100%">
                                    <AreaChart data={performanceData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                                        <defs><linearGradient id="colorScore" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#2563eb" stopOpacity={0.2} /><stop offset="95%" stopColor="#2563eb" stopOpacity={0} /></linearGradient></defs>
                                        <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f1f5f9" />
                                        <XAxis dataKey="month" axisLine={false} tickLine={false} tick={{ fill: "#94a3b8", fontSize: 12 }} dy={10} />
                                        <YAxis axisLine={false} tickLine={false} tick={{ fill: "#94a3b8", fontSize: 12 }} domain={[60, 100]} />
                                        <Tooltip contentStyle={{ borderRadius: 12, border: "1px solid #e2e8f0", boxShadow: "0 4px 12px rgba(0,0,0,0.08)", fontSize: "0.8125rem" }} cursor={{ stroke: '#2563eb', strokeWidth: 1, strokeDasharray: '5 5' }} />
                ...
                <Grid size={{ xs: 12 }}>
                    ...
                    <Grid container spacing={2}>
                        {[
                            ...
                            const colors = { warning: { accent: "#d97706", bg: "#fffbeb", border: "#fef3c7" }, success: { accent: "#16a34a", bg: "#f0fdf4", border: "#dcfce7" }, info: { accent: "#2563eb", bg: "#eff6ff", border: "#dbeafe" } }[insight.status]!;
                            return (
